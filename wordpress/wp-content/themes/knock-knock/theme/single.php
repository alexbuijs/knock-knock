...
switch(get_post_type()) {
    case 'agenda':
        ...
        $context['agendaUrl'] = get_bloginfo('url') . "/agenda?maand=$month&jaar=$year";
        break;
    case 'documentatie': 
        $post = Timber::get_post(false, 'App\PostTypes\DocPost');
        $context['authorThumbnail'] = App\getUserImage('thumbnail', $post->post_author);
        $context['authorLink'] = App\userLink(get_user_by('ID', $post->post_author), $linkable = true, $lastName = false);
        break;
    case 'house': 
