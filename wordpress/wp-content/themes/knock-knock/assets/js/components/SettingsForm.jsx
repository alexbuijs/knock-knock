        ...
        <form>
            ...
            <div className="theme-select d-flex align-items-center">
                ...
                <div className="d-flex">
                    <div className="form-check custom-control-inline me-4 mt-2 d-flex align-items-center">
                    ...
                    <div className="form-check custom-control-inline mt-2 d-flex align-items-center">
